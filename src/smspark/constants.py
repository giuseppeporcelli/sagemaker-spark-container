...
AWS_SPARK_DRIVER_LOG_DESTINATION_NONE = 0
AWS_SPARK_DRIVER_LOG_DESTINATION_S3 = 1

AWS_SPARK_EXECUTOR_LOG_DESTINATION_NONE = 0
AWS_SPARK_EXECUTOR_LOG_DESTINATION_S3 = 1